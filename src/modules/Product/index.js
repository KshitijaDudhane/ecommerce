...
const Product = () => {
     ...
     useEffect(() => {
      ...
      const handleCart = (product , redirect) =>{
        ...
        const isProductExist = cart.find(item => item.id === id.product)
        if(isProductExist){
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="flex ml-auto  border border-pink-500  py-2 px-6 focus:outline-none hover:bg-pink-600 hover:text-white rounded " onClick = {() => handleCart(product)}>Add to Cart</button>
          </div>
